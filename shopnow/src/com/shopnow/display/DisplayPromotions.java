...
public class DisplayPromotions extends Activity {
	private String infoid;
	private ListView lv;
	private ProgressBar pBar;

	private class FetchOffersTask extends AsyncTask<Void, Void, ItemAdapter> {
		...
		protected ItemAdapter doInBackground(Void... params) {
			ArrayList<ItemEntry> promotions = TaskManager.getPromotions(infoid);
...
//						Toast.LENGTH_SHORT).show();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		((TextView) findViewById(R.id.title)).setText("Promotions - "+getIntent()
				.getStringExtra("name"));
