...
import com.shopnow.display.DisplayPromotions;
...
public class PromotionsFrag extends Fragment {
	...
	private class FetchCategoriesTask extends AsyncTask<Void, Void, Boolean> {
		...
		protected Boolean doInBackground(Void... params) {
			List<String> cats = TaskManager.getPromotionCategories();
			if (cats != null) {
	...
	private class FetchSubcategoriesTask extends
		...
		protected Boolean doInBackground(Integer... params) {
			...
			List<ItemEntry> subs = TaskManager
					.getPromotionSubCategories(groupName);
			if (subs != null) {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		((TextView) view.findViewById(R.id.title)).setText("Promotions");
